                ...
                <div className="max-w-7xl mx-auto text-center">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <p className="text-xl md:text-2xl text-gray-600 mb-8 leading-relaxed">
                            The smart way to map out your 4-year academic path
                            at Georgia Tech. Stay on track, meet requirements,
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            Comprehensive tools designed specifically for
                            Georgia Tech students to navigate their academic
                            journey
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description:
                                    "Visualize your entire 4-year schedule with prerequisite tracking and conflict detection",
                            },
                            {
                                icon: Target,
                                title: "Degree Progress Tracking",
                                description:
                                    "Monitor your progress toward graduation with real-time requirement fulfillment",
                            },
                            {
                                icon: BookOpen,
                                title: "Course Recommendations",
                                description:
                                    "Get personalized suggestions based on your major, interests, and academic goals",
                            },
                            {
                                icon: Users,
                                title: "Peer Collaboration",
                                description:
                                    "Connect with classmates, share schedules, and plan study groups together",
                            },
                            {
                                icon: TrendingUp,
                                title: "GPA Forecasting",
                                description:
                                    "Predict your future GPA and see how different course choices impact your goals",
                            },
                            {
                                icon: Shield,
                                title: "Academic Safeguards",
                                description:
                                    "Built-in alerts for prerequisite violations, credit limits, and graduation requirements",
                            },
                        ].map((feature, index) => (
                            <div
                                key={index}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                                Join thousands of Yellow Jackets who have
                                successfully planned their academic journey with
                                our platform.
                            </p>

                            <div className="grid grid-cols-2 gap-8 mb-8">
                                <div className="text-center">
                                    <div className="text-3xl font-bold bg-gradient-to-r from-blue-900 to-yellow-600 bg-clip-text text-transparent mb-2">
                                        98%
                                    </div>
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-900 to-yellow-600">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-xl text-white/90 mb-8">
                        Join thousands of successful Yellow Jackets who planned
            ...
            <footer className="border-t border-gray-200 py-12 px-4 sm:px-6 lg:px-8 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div>
                            ...
                            <p className="text-gray-600">
                                Empowering Georgia Tech students to plan their
                                perfect academic journey.
                            </p>
                        </div>
                    ...
                    <div className="border-t border-gray-200 mt-8 pt-8 text-center text-gray-500">
                        <p>
                            &copy; 2025 GT 4-Year Planner. Not affiliated with
